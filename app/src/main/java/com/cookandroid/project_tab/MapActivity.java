...
public class MapActivity extends AppCompatActivity
    ...
    {
        System.out.println("show Palce Info");
        mMap.clear();//지도 클리어
        ...
        new NRPlaces.Builder()
                ...
                .key("AIzaSyBjwvPxzkBiuaTnBw8ezzHGTUxWEWflSrU")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button)findViewById(R.id.placeBtn);
            ...
            public void onMapLongClick(final LatLng latLng) {
                ...
                button_submit.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        Toast.makeText(MapActivity.this, string_placeTitle+"\n"+string_placeDesc,Toast.LENGTH_SHORT).show();
    ...
    public boolean onMarkerClick(@NonNull @org.jetbrains.annotations.NotNull Marker marker) {
        addedMarker = marker;
        System.out.println("addedMarker: " + addedMarker);
        return false;
    }
            ...
            if (locationList.size() > 0) {
                ...
                if ( (addedMarker != null) && tracking == 1 ) {
                    ...
                    if ((distance < radius) && (!previousPosition.equals(currentPosition))) {
                        ...
                        Toast.makeText(MapActivity.this, addedMarker.getTitle() + "까지" + (int) distance + "m 남음", Toast.LENGTH_LONG).show();
                    }
                }
